...
class KilosortDriftMapWidget(BaseWidget):
    ...
    def plot_matplotlib(self, data_plot: dict, **unused_kwargs) -> None:
        ...
        spike_times, spike_amplitudes, spike_depths, _ = self._compute_spike_amplitude_and_depth(
    ...
    def _compute_spike_amplitude_and_depth(
        ...
        params = self._load_ks_dir(sorter_output, load_pcs=True, exclude_noise=exclude_noise)
        ...
        spike_amplitudes, _, _, _, unwhite_templates, *_ = self._template_positions_amplitudes(
            params["templates"],
